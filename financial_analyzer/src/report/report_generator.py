...
def _build_report(context: dict[str, Any], code: str, name: str, rating: str) -> str:
    ...
    lines = [
        ...
        "", "## 三、指标口径与来源追溯", "", _provenance_lines(metric_provenance, ["毛利率", "年度ROE", "季度ROE", "单季度年化ROE", "自由现金流", "资产负债率", "PE 动态", "PE TTM", "行情源PEG", "PEG"]),
        "", "## 四、盈利能力", "", _factor_lines(factors, ["毛利率", "净利率", "扣非净利率", "年度ROE", "季度ROE", "单季度年化ROE", "ROA", "研发费用率"], metric_provenance),
        ...
        "", "## 八、估值压力", "", _factor_lines(factors, ["PE 动态", "PE TTM", "行情源PEG", "PEG", "PB 行情源", "PB", "行情源PS", "PS", "市值/扣非净利润", "市值/经营现金流"], metric_provenance),
