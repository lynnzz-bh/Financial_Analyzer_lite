...
METRIC_REGISTRY: dict[str, MetricDefinition] = {
    ...
    "PB": {
        "category": "估值",
        "formula_text": "行情源提供的 PB",
        "caliber_note": "直接沿用 market_data，不由本项目重算。",
        "source_reports": ["market_data"],
        "source_fields": {"market_data": ["PB"]},
        "unit": "multiple",
        "is_ttm": False,
        "period_note": "行情源最新可用口径。",
    },
    ...
    "PEG": {
        ...
        "caliber_note": "PE TTM 来自行情数据，增长率由现有 TTM 扣非归母净利润同比口径推导。",
        "source_reports": ["market_data", "income_statement"],
        "source_fields": {"market_data": ["PE TTM"], "income_statement": ["扣非归母净利润"]},
        "unit": "multiple",
        "is_ttm": True,
        "period_note": "PE 为行情源 TTM；增长率使用最新报告期对应的 TTM 同比。",
    },
    "市值/扣非净利润": {
        "category": "估值",
